                ...
                for dx in range(4):
                    for dy in range(4):
                        if random.random() >= 0.2:  # Random pattern with 0.2 => 80% coverage
                            stone_surface.set_at((x+dx, y+dy), stone_color)
                        elif random.random() >= 0.5:
                            stone_surface.set_at((x+dx, y+dy), stone_color2)
                        elif random.random() >= 0.75:
                            stone_surface.set_at((x+dx, y+dy), stone_color3)                
...
while running:
    ...
    pygame.image.save(stone.image, "stone_surface.jpg")    
